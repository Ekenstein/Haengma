...
namespace Haengma.Core.Services
{
    ...
    {
        public static Task CreateGameAsync(this ServiceContext serviceContext, GameSettings gameSettings, UserId black, UserId white) => serviceContext.Transactions.WriteAsync(async tx =>
        {
        ...
        public static Task AddMoveAsync(this ServiceContext serviceContext, GameId gameId, UserId userId, Point point) => serviceContext.Transactions.WriteAsync(async tx =>
        {
            await serviceContext.Logics.Game.AddMoveAsync(tx, gameId, userId, point);
            return Unit.Value;
        });

        public static Task PassAsync(this ServiceContext serviceContext, GameId gameId, UserId userId) => serviceContext.Transactions.WriteAsync(async tx =>
        {
        ...
        public static Task ResignAsync(this ServiceContext serviceContext, GameId gameId, UserId userId) => serviceContext.Transactions.WriteAsync(async tx =>
        {
